...
test_datasets = ['BREAST',  # seems ok
    # 'CERV',  requires discretization
    # 'HIV',  # seems ok
    # 'NURSERY',  # has ALL instances, and also seems redundant. so it's trivial to solve
    #'PRIMARY'  # seems ok
    #'LYMPHOGRAPHY'
]
...
def bpl_estimator(data):
    ...
    for name, (X, y) in data:
        ...
        for n_rules in [8, 16, 24]:
            ...
            print('acc:', np.mean(y_test == y_pred_best_k))
